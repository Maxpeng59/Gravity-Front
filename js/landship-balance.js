...
export const LANDSHIP_PROFILES = Object.freeze({
  bigtray: Object.freeze({
    ...
    mainDamage: 900, mainSplash: 22, mainRof: [4.8, 6.6], mainRange: 2800, shellSpeed: 620, shellLife: 6.8, shellScale: 1.45,
  ...
  dabude: Object.freeze({
    ...
    mainDamage: 1325, mainSplash: 30, mainRof: [7.2, 9.6], mainRange: 3400, shellSpeed: 560, shellLife: 8, shellScale: 1.7,
  ...
  gallop: Object.freeze({
    ...
    mainDamage: 650, mainSplash: 19, mainRof: [4.4, 6.2], mainRange: 2400, shellSpeed: 680, shellLife: 5.5, shellScale: 1.25,
    fixedDamage: 0, fixedSplash: 0, fixedRof: [99, 99], fixedShots: 0,
