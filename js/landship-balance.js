...
export const LANDSHIP_PROFILES = Object.freeze({
  bigtray: Object.freeze({
    ...
    secondaryDamage: 48, secondaryRof: [1.1, 1.55], secondaryStations: 8, secondaryRange: 1200,
  ...
  dabude: Object.freeze({
    ...
    secondaryDamage: 58, secondaryRof: [1.35, 1.9], secondaryStations: 6, secondaryRange: 1050,
  ...
  gallop: Object.freeze({
    ...
    fixedDamage: 0, fixedSplash: 0, fixedRof: [99, 99], fixedShots: 0,
    secondaryDamage: 44, secondaryRof: [1.0, 1.45], secondaryStations: 3, secondaryRange: 1000,
